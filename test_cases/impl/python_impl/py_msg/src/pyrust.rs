...
impl MsgSimpleBaseThreeInt {
  ...
  pub fn from_rust_obj(_d: &messages::MsgSimpleBaseThreeInt) -> PyResult<Self> {
    let r = Python::with_gil(|_py| { Self{ param_1: _d.param_1.val_into(), param_2: _d.param_2.val_into(), param_3: _d.param_3.val_into(), param_4: _d.param_4.val_into(),} });
    Ok(r)
  }
}
...
impl MsgSimpleTestBase {
  ...
  pub fn from_rust_obj(_d: &messages::MsgSimpleTestBase) -> PyResult<Self> {
    let r = Python::with_gil(|_py| { Self{ param_1: _d.param_1.val_into(), param_2: _d.param_2.val_into(), param_3: _d.param_3.val_into(), name: _d.name.val_into(),} });
    Ok(r)
  }
}
...
impl MsgSimpleTestFP {
  #[new]  #[allow(non_snake_case)]
  pub fn __new__( param_1: bool, fp: f64, fpl: f64,) -> Self {
    Self{ param_1: param_1.into(), fp: fp.into(), fpl: fpl.into(), }
  }
  #[staticmethod]
  pub fn default() -> PyResult<Self> { Self::from_rust_obj(&Default::default()) }
...
impl MsgSimpleTestFP {
  pub fn to_rust(&self) -> messages::MsgSimpleTestFP {
    Python::with_gil(|_py| {
      messages::MsgSimpleTestFP{ param_1: do_val_from(&self.param_1), fp: do_val_from(&self.fp), fpl: do_val_from(&self.fpl),}
    })
  }
  pub fn from_rust_obj(_d: &messages::MsgSimpleTestFP) -> PyResult<Self> {
    let r = Python::with_gil(|_py| { Self{ param_1: _d.param_1.val_into(), fp: _d.fp.val_into(), fpl: _d.fpl.val_into(),} });
    Ok(r)
  }
}
...
impl MsgSimpleOpt {
  ...
  pub fn from_rust_obj(_d: &messages::MsgSimpleOpt) -> PyResult<Self> {
    let r = Python::with_gil(|_py| { Self{ param_1: _d.param_1.val_into(), param_2: _d.param_2.val_into(), param_3: _d.param_3.val_into(), param_4: _d.param_4.val_into(),} });
    Ok(r)
  }
}
