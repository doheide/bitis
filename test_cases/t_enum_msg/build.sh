...
../../target/debug/bitis -d compile -i enum_msg.bitis -o ../impl/rust_impl/src/messages.rs -l rust

../../target/debug/bitis -d compile -i enum_msg.bitis -o ../impl/cpp_impl/src/messages.h -l cpp

cd ../impl/python_impl/
. ./.venv/bin/activate
../../../target/debug/bitis compile -i $test_dir/enum_msg.bitis --prevent-update-bitis-lib-in-crate -l python -o py_msg/
cd -
