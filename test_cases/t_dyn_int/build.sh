...
echo -e "\n"
../../target/debug/bitis -d -i dyn_int.bitis compile -o ../impl/rust_impl/src/messages.rs -l rust

echo -e "\n"
../../target/debug/bitis -d -i dyn_int.bitis compile -o ../impl/cpp_impl/src/messages.h -l cpp
